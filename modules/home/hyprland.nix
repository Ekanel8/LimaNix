  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      monitor = [
        ...
        "HDMI-A-1,2560x1440@144,1600x0,1.33"
      ];
      ...
      general = {
        ...
        gaps_out = 20;
        border_size = 2;
        "col.active_border" = "rgba(33ccffee) rgba(33ccffee) 45deg";
      ...
      bind = [
        ...
        "$mainMod, O, exec, OBSIDIAN_USE_WAYLAND=1 obsidian --ozone-platform=wayland --enable-features=UseOzonePlatform"
